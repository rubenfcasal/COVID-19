...
* [acumulados.RData](acumulados.RData): Evolución de los valores acumulados por CCAA y para el total de España (formato adecuado para el proyecto [Predicción Cooperativa](#proyecto-de-predicción-cooperativa). 
...
* [Instituto de Salud Carlos III (ISCIII)](https://cnecovid.isciii.es)
    ...
    - Datos por “fecha de diagnóstico” (ver [metadata](https://cnecovid.isciii.es/covid19/resources/metadata_diag_ccaa_decl_prov_edad_sexo.pdf))
