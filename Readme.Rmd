...
* El archivo [historico_cp.RData](prediccion_cooperativa/historico_cp.RData) en la carpeta [prediccion\_cooperativa](https://rubenfcasal.github.io/COVID-19/prediccion_cooperativa) contiene las predicciones cooperativas obtenidas durante la vigencia del proyecto.
