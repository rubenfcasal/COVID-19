...
o los datos del ISCIII que continuaré procesando (pese a los comentarios 
descritos más adelante en las notas...). 
...
Aunque en versiones anteriores se suponía que se consideraban confirmados solo los positivos por PCR, aparentemente no es el caso, por lo se sustituyeron estos valores por la suma de `PCR+` y `TestAC+` (Galicia ya reporta como casos `PCR+` y `TestAC+`).
