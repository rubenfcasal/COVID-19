...
También creemos que hay errores en los datos de recuperados de Galicia del 17 y 18 abril (reportan sendos ceros cuando en el informe del MSCBS habían reportado 1507 y 1536 respectivamente). 
Seguramente hay más errores, ya que los encargados de los datos (y sus superiores) de las CCAA y del MSCBS/ISCIII son **aparentemente** unos cracks! (i.e. sobresalen, hacen las cosas bien hechas, ...).
