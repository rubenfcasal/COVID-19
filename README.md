...
En [COVID-19-tablas.html](COVID-19-tablas.html) se muestran las tablas disponibles a fecha de ***2020-04-06***. Las tablas (con un procesado mínimo) están almacenadas en los archivos:
